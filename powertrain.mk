...
service-deploy:
	$(POWERTRAIN_DIR)/scripts/service.sh $(NAME) $(VERSION) $(REGISTRY) $(INSTANCES) $(PUBLISHED_PORTS) $(ENVS) $(LABELS) $(UPDATE_DELAY) $(PARALLEL_UPDATES) $(CONSTRAINTS) $(NETWORKS) $(SERVICE_MODE) $(LIMIT_CPU) $(LIMIT_MEM) $(RESERVE_CPU) $(RESERVE_MEM) $(MOUNTS) $(LOG_DRIVER) $(LOG_OPTS) 
