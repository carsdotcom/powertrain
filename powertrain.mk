...
.PHONY: run
run:
	$(POWERTRAIN_DIR)/scripts/run.sh $(NAME) $(VERSION) $(REGISTRY) $(INSTANCES) $(NET) $(RESTART) $(EXPOSE) $(PORTS) $(VOLUMES) $(ENVS) $(LABELS) $(LOG_DRIVER) $(LOG_OPTS) $(RUN_SCRIPT) $(VERSION_SCRIPT)
